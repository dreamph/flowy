...
func MultipartBodyParser[RequestCtx WebCtx](c RequestCtx, targetPtr interface{}) error {
...
func IsMultipartForm[RequestCtx WebCtx](c RequestCtx) bool {
	return strings.Contains(c.Get(HeaderContentType), MIMEMultipartForm)
}

func IsOctetStream[RequestCtx WebCtx](c RequestCtx) bool {
